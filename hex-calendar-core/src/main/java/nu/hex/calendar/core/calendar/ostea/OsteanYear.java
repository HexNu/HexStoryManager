 ...
 * @author hl
 */
public class OsteanYear implements CalendarYear {

    public static final int MIN_VALUE = -999_999_999;
    public static final int MAX_VALUE = 999_999_999;
    private final int year;

    private OsteanYear(int year) {
        this.year = year;
    }

    public static OsteanYear of(int year) {
        validate(year);
        return new OsteanYear(year);
    }
    ...
    public CalendarDate atDay(int dayOfYear) {
        return OsteanDate.ofYearDay(year, dayOfYear);
    }

    @Override
    public CalendarYearMonth atMonth(int month) {
        return OsteanYearMonth.of(year, month);
    }
    ...
    public static void main(String[] args) {
        CalendarYear a = OsteanYear.of(1900);
        CalendarYear b = OsteanYear.of(2000);
