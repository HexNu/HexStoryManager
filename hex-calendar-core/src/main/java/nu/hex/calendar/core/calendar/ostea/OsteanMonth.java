 ...
 * @author hl
 */
public enum OsteanMonth implements CalendarMonth {
    VLETIM,
    TOTES,
    UCAPS,
    CALIPS,
    ...
    DEMEK,
    GRAG;
    private static final OsteanMonth[] ENUMS = OsteanMonth.values();
    ...
    public static OsteanMonth of(int month) {
        if (isValid(month)) {
