 ...
 * Created 2016-okt-23
 * <br>
 * Calculate approximate exchange rate for pound and dollar between 1791 and
 * 2015.
 *
 *
 * @author hl
...
public class PoundToDollarConverter {
    ...
    /**
     * Returns the calculated result with up to four decimal digits
     *
     * @param dollar
     * @return
     */
    ...
    public Double getPoundToDollar(Double pound) {
        return getDoubleWithUpToFourDecimalDigits(pound * RATIO_MAP.get(year));
    }
    ...
    public static void main(String[] args) {
        System.out.println(new PoundToDollarConverter(1854).getPoundToDollar(1234));
    }
