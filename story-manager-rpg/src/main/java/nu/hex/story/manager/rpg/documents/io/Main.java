...
//        }
        List<CampaignDocument> campaigns = new SmrxXmlReader("/home/hl/Dokument/RPG/Northern Lights.smrx").read();
//        campaigns.get(0).setPersons(persons);
        
        XmlDocument doc = new SmrxXmlWriter(campaigns).write();
        new FileWriter(doc, "/home/hl/Dokument/RPG/Northern Lights 2.smrx").write();
